...
export default function SupplierDetailModal() {
    return (
        <Modal modalKey="supplier-detail" title={null} wrapperClassname="!max-w-[70vw] w-[70vw]">
            <SupplierDetail />
        </Modal>
    )
}
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            <div className="flex items-start justify-between gap-3">
                <div>
                    <h2 className="text-lg font-bold">{supplier.company_name}</h2>
            ...
            <Section title="General">
                <div className="grid grid-cols-3 divide-x divide-y">
                    <Cell label="Activity field" value={supplier.activity_field} />
                    <Cell label="INN" value={supplier.inn} />
                    <Cell label="OKPO code" value={supplier.okpo_code} />
                    <Cell label="Balance" value={supplier.balance != null ? supplier.balance.toLocaleString() : null} />
                    <Cell
                        label="Date joined"
                        value={supplier.date_joined ? new Date(supplier.date_joined).toLocaleDateString() : null}
                    />
                </div>
            </Section>
            ...
            <Section title="Contact">
                <div className="grid grid-cols-3 divide-x divide-y">
                    ...
                    <Cell label="Company phone" value={supplier.company_phone} />
                    <Cell label="Company email" value={supplier.company_email} />
                </div>
            </Section>
            ...
            <Section title="Address">
                <div className="grid grid-cols-3 divide-x divide-y">
                    ...
                    <Cell label="Exact address" value={supplier.exact_address} />
                    <Cell label="Legal address" value={supplier.legal_address} />
                </div>
            </Section>
            ...
            <Section title="Bank">
                <div className="grid grid-cols-3 divide-x divide-y">
                    ...
                    <Cell label="Account number" value={supplier.account_number} />
                </div>
            </Section>
            ...
            {supplier.notes && (
                <Section title="Notes">
                    <p className="px-4 py-3 text-sm text-muted-foreground">{supplier.notes}</p>
                </Section>
            )}
        </div>
    )
